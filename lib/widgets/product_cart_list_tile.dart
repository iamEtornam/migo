                ...
                Row(
                  children: [
                    ...
                    QuantityInput(
                      value: quantity,
                      onChanged: (val) {
                        widget.product.qty = int.parse(val);
                        widget.invoiceController.productList[widget.index].qty =
                            int.parse(val);
                  ...
                  var priceToBeDeducted = int.parse(widget
                      ...
                      .substring(
                          ...
                          widget.invoiceController.productList[widget.index]
                                  ...
                                  .length -
                              3));
                  priceToBeDeducted = priceToBeDeducted * widget.product.qty!;
                  // var priceToBeDeducted = widget.product.qty! *
                  //     int.parse(widget.product.sellingPrice!
                  //         .substring(widget.product.sellingPrice!.length - 3));
